...
ALLOWED_HOSTS = ['54.245.126.177','med-app.ca', 'www.med-app.ca', 'localhost', '127.0.0.1']
...
#     "http://54.245.126.177:3000", 'http://localhost:3000', 'https://medical-frontend-kappa.vercel.app/'  
